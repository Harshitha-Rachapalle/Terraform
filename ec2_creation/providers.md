...
search terraform providers in google where we can see 3 types of providers 1. official 2. partner 3. community

Provider in terraform is a plugin that enables interaction with an API. 
